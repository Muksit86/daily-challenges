        ...
        <div className="max-w-3xl w-full animate-fade-in">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 md:p-8 rounded-xl shadow-md border dark:border-slate-700 animate-slide-up">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition-all duration-200 hover:shadow-lg active:scale-95 shadow-md"
              >
                Send Message
              </button>
            </form>
